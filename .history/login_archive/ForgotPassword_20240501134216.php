...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    try{
        ...
        $check_email = $pdo->prepare("SELECT s_enterprisename_entidade, s_email_entidade, s_enterpriseemail_entidade FROM entidade WHERE s_email_entidade = :email");
        ...
        if ($check_email->rowCount()>0) { // CONFERE SE HÁ QUERIES CORRESPONDENTES
            ...
            $user_name = $result['s_enterprisename_entidade']; // ATRIBUI O NOME DO USUÁRIO A VARIAVEL $user_name
