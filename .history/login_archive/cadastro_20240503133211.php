            ...
            <div class="card-body">
                ...
                <form method="POST" action="UserSignUp.php">
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="inputGroup-sizing-default" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Informação obrigatória">Nome da Empresa *</span>
